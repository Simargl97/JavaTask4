...
public class HomeWork3 {
    public static void main(String[] args) {
        ...
        System.out.println(
                "Калькулятор 2.0!\n" +
                        "Если ввести слово 'Отмена', то отмениться последнее действие и вернет предыдущий результат!");
        ...
        while (calc) {
            ...
            if (operation.equals("отмена")) {
                if (!number_list.isEmpty()) {
                    ...
                    System.out.println("Текущий результат отсутствует. Попробуйте заново!");
                    number1 = input_number(sc);
                }
                operation = input_operation(sc);
            }
    ...
    public static String input_operation(Scanner scanner) {
        System.out.println("Введите действия или 'Отмена':");
